...
from playground.color_generation import sample_color
...
class Thing:
    ...
    def _update_position(self, new_position):
        clipped_position = np.clip(new_position, -1.5, 1.5)
    ...
    def get_features(self):
        ...
        """
        grasped_feature = np.array([1]) if self.grasped >= 0 else np.array([-1])
